// This JavaScript program reads "posts.json" and renders the data to the page.
...
(function () {
    ...
    function renderPosts(posts) {
        ...
        posts.forEach(function (post) {
            ...
            var postDiv = document.createElement("div"), //creating the outer div
                postNameDiv = document.createElement("div"), //inner div
